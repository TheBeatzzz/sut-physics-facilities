...
const textTranslations = {
  ...
  "Equipment names and figures below are illustrative. Replace them with verified institutional data.": "ชื่อครุภัณฑ์และตัวเลขด้านล่างเป็นข้อมูลตัวอย่าง กรุณาแทนที่ด้วยข้อมูลสถาบันที่ตรวจสอบแล้ว",
  ...
  "Showing live facilities and verified equipment approved for the public research profile.": "กำลังแสดงห้องปฏิบัติการออนไลน์และครุภัณฑ์ที่ตรวจสอบแล้วซึ่งอนุมัติให้แสดงในโปรไฟล์วิจัยสาธารณะ",
  "Showing live facilities from Supabase. Equipment records will appear after they are verified and marked public.": "กำลังแสดงห้องปฏิบัติการจาก Supabase รายการครุภัณฑ์จะแสดงเมื่อผ่านการตรวจสอบและกำหนดให้เป็นสาธารณะ",
  "Showing live facilities from Supabase and example equipment until verified public equipment records are available.": "กำลังแสดงห้องปฏิบัติการจาก Supabase พร้อมครุภัณฑ์ตัวอย่างจนกว่าจะมีรายการครุภัณฑ์สาธารณะที่ตรวจสอบแล้ว",
  "Supabase is connected, but no equipment has been approved for public display yet. Showing example records until the registry is populated.": "เชื่อมต่อ Supabase แล้ว แต่ยังไม่มีครุภัณฑ์ที่อนุมัติให้แสดงสาธารณะ จึงแสดงรายการตัวอย่างจนกว่าจะมีข้อมูลในระบบจัดการ",
  ...
  "Explore the shared instruments, specialist spaces, and technical expertise that move ideas from first observation to reproducible result.": "สำรวจเครื่องมือใช้ร่วมกัน ห้องปฏิบัติการวิจัย และความเชี่ยวชาญทางเทคนิคที่ช่วยพัฒนาแนวคิดจากการสังเกตครั้งแรกไปสู่ผลลัพธ์ที่ทำซ้ำได้",
  "Explore the equipment": "ดูครุภัณฑ์",
  ...
  "One connected environment for biomedical photonics, spectroscopy, fabrication, lasers, integrated photonics, quantum technology, and artificial intelligence.": "สภาพแวดล้อมที่เชื่อมโยงงานโฟโตนิกส์ชีวการแพทย์ สเปกโทรสโกปี การสร้างชิ้นงาน เลเซอร์ โฟโตนิกส์เชิงบูรณาการ เทคโนโลยีควอนตัม และปัญญาประดิษฐ์",
  ...
  "Explore the laboratory clusters that host public-facing equipment, expertise, and example use cases.": "สำรวจกลุ่มห้องปฏิบัติการที่มีครุภัณฑ์ ความเชี่ยวชาญ และตัวอย่างการใช้งานสำหรับผู้สนใจ",
  "Equipment atlas": "แอตลาสครุภัณฑ์",
  "Tools for asking": "ตอบโจทย์วิจัยที่ท้าทาย",
  "better questions.": "ด้วยเทคโนโลยีที่เราสร้างเอง",
  "Filter the sample collection by the part of the research process it supports.": "กรองรายการตัวอย่างตามส่วนของกระบวนการวิจัยที่ครุภัณฑ์รองรับ",
  "All equipment": "ครุภัณฑ์ทั้งหมด",
  ...
  "Select an equipment record to contact its responsible person.": "เลือกครุภัณฑ์เพื่อดูผู้รับผิดชอบที่สามารถติดต่อได้",
  "Project inquiry": "สอบถามโครงการ",
  "Discuss an equipment project": "ปรึกษาโครงการที่เกี่ยวกับครุภัณฑ์",
  "Close inquiry form": "ปิดแบบฟอร์มสอบถาม",
  "Equipment of interest": "ครุภัณฑ์ที่สนใจ",
  "Choose equipment": "เลือกครุภัณฑ์",
  "contact email needed": "ต้องเพิ่มอีเมลติดต่อ",
  "Select equipment to see the responsible contact.": "เลือกครุภัณฑ์เพื่อดูผู้รับผิดชอบ",
  ...
  "Equipment gallery": "แกลเลอรีครุภัณฑ์",
  "Example use-case gallery": "แกลเลอรีตัวอย่างการใช้งาน",
  "Full-size image": "ภาพขนาดเต็ม",
  "Close image preview": "ปิดตัวอย่างภาพ",
  "Prototype interface · Replace sample content before publication": "หน้าต้นแบบ · กรุณาแทนที่ข้อมูลตัวอย่างก่อนเผยแพร่จริง",
  ...
  "Connect research questions with faculty expertise, facility leads, and responsible equipment contacts across the Physics Program.": "เชื่อมคำถามวิจัยกับความเชี่ยวชาญของคณาจารย์ หัวหน้าห้องปฏิบัติการ และผู้รับผิดชอบครุภัณฑ์ในสาขาวิชาฟิสิกส์",
  ...
  "Browse faculty expertise, research interests, and contact pathways for study, research collaboration, services, and facility questions.": "ดูความเชี่ยวชาญ ความสนใจด้านวิจัย และช่องทางติดต่อสำหรับการเรียน การร่วมวิจัย บริการวิชาการ และคำถามเกี่ยวกับห้องปฏิบัติการ",
  ...
  "Start with the research area, facility, or equipment closest to your question. We can help identify an appropriate faculty contact.": "เริ่มจากด้านวิจัย ห้องปฏิบัติการ หรือครุภัณฑ์ที่ใกล้กับคำถามของคุณ เราสามารถช่วยระบุคณาจารย์ที่เหมาะสมสำหรับการติดต่อได้",
  ...
  "Request support for certified measurements, short courses, workshops, and STEM activities connected to physics expertise at SUT.": "ขอรับการสนับสนุนด้านการวัดที่รับรองได้ หลักสูตรระยะสั้น เวิร์กช็อป และกิจกรรม STEM ที่เชื่อมโยงกับความเชี่ยวชาญด้านฟิสิกส์ของ มทส.",
  ...
  "Your answers help us understand the service area, audience, timing, and outcome you have in mind.": "คำตอบของคุณช่วยให้เราเข้าใจประเภทบริการ กลุ่มเป้าหมาย ช่วงเวลา และผลลัพธ์ที่ต้องการ",
  ...
  "Public equipment records linked to this facility.": "รายการครุภัณฑ์สาธารณะที่เชื่อมโยงกับห้องปฏิบัติการนี้",
  ...
  "Add a facility and link verified public equipment records to display it here.": "เพิ่มห้องปฏิบัติการและเชื่อมโยงครุภัณฑ์สาธารณะที่ตรวจสอบแล้วเพื่อแสดงในส่วนนี้",
  "Verified": "ตรวจสอบแล้ว",
  "Sample": "ตัวอย่าง",
  "Contact the facility for equipment capabilities and use cases.": "ติดต่อห้องปฏิบัติการเพื่อสอบถามความสามารถของครุภัณฑ์และตัวอย่างการใช้งาน",
  ...
  "No public equipment record currently has a contact email. Add one in the Equipment Registry.": "ยังไม่มีรายการครุภัณฑ์สาธารณะที่มีอีเมลติดต่อ กรุณาเพิ่มในระบบจัดการครุภัณฑ์",
  "This equipment does not yet have a valid contact email.": "ครุภัณฑ์นี้ยังไม่มีอีเมลติดต่อที่ถูกต้อง",
  "Responsible equipment contact": "ผู้รับผิดชอบครุภัณฑ์",
  ...
  "No linked equipment yet": "ยังไม่มีครุภัณฑ์ที่เชื่อมโยง",
...
const attributeTranslations = {
  "A prototype infographic page for presenting academic research equipment, facilities, and collaboration pathways.": "หน้าต้นแบบสำหรับนำเสนอครุภัณฑ์วิจัย ห้องปฏิบัติการ และแนวทางความร่วมมือทางวิชาการ",
...
const titleTranslations = {
  "Research Instruments & Facilities": "ครุภัณฑ์และห้องปฏิบัติการวิจัย",
...
const patternTranslations = [
  ...
  [/^Showing (\d+) verified public equipment records? alongside example fallback equipment\.$/, count => `กำลังแสดงครุภัณฑ์สาธารณะที่ตรวจสอบแล้ว ${count} รายการ พร้อมครุภัณฑ์ตัวอย่าง`],
  ...
  [/^Equipment: (.+)$/, value => `ครุภัณฑ์: ${value}`],
