...
The latest schema also restricts registered faculty student access to their own advisees. Student records without an advisor are assigned to `FACULTY-001` for verification and management.
